...
Story.intro = function () {
  return [
    ...
    { s: SP.narr, t: `(กดปุ่ม ${typeof Keybind !== "undefined" ? Keybind.primaryLabel("interact") : "␣"} หรือ ✦ ตอนอยู่ใกล้อาจารย์โรวัน 🧙 เพื่อเริ่มการผจญภัย · เปิด 'เนื้อเรื่อง' เพื่อดูภารกิจปัจจุบัน)` },
  ];
};
